  ...
  <body style="background-color:#AAAAAA;">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link enabled" href="reset.php" tabindex="-1" aria-disabled="true">Reset password</a>
                </li>
                <li class="form-inline my-2 my-lg-0">
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if($count == 1) 
    {
            ...
            $sql = "UPDATE User SET hashedpwd='$hashednewpass' WHERE  username='$username' and hashedpwd='$pass' ";
...
<form action = "<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"  enctype="multipart/form-dat">
  ...
  <p>
      ...
      <label>New Password : </label><input type = "password" name = "newpwd" />
  </p>
  <p id="demo"></p>
